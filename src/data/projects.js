export const PROJECT_REGISTRY = [
  ...
  },
  {
    ...
    title: "On My Way",
    shortDescription:
      "A full-stack travel planning web app that helps users organize trips, discover excursions, and manage itineraries in one place.",
    heroImage: "/omwPhotos/OMW-exploreexcursions.png",
    heroImageAlt: "On My Way excursion search results page",
    techStack: ["React", "JavaScript", "Flask", "PostgreSQL", "TripAdvisor API"],
    bg: {
    ...
    sections: [
      ...
      { id: "tech-stack", label: "Tech Stack" },
      {
        ...
        label: "Key Features & Implementation",
      },
      ...
      {
        id: "excursion-search-tripadvisor-api",
        label: "Excursion Search (TripAdvisor API)",
      },
